...
public class EmployeeRepositoryTest {
    ...
    private EmplyeeDao employeeRepository = null;

    @Before
    public void setup() {
        ctx = new ClassPathXmlApplicationContext("spring/spring-data.xml");
        employeeRepository = ctx.getBean(EmplyeeDao.class);
